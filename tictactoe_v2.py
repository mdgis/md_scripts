...
def tic_tac_toe():    
    ...
    def computer_move(board, index_dict, index, diff = 'easy'):
        print board
        moves = []
        for item in index[0]:
...
#                    continue
    ...
    def playing():
        ...
        print 'Please enter the index (Number followed by letter: \n For Example -> 1A to put X in first column first row \n What is your move? '
        ...
        while match_check(board):    
            ...
            moveI, moveJ = move_call(index, turn_count, board, index_dict, computer)
            print 'i got back to match check'
            print moveI, moveJ
            print index_dict
